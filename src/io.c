...
static void default_write_term(trilog_ctx_t *ctx, term_t *t, env_t *env,
                               void *userdata) {
  (void)userdata;
  print_term(ctx, t, env, false);
}

static void default_writef(trilog_ctx_t *ctx, const char *fmt, va_list args,
                           void *userdata) {
  (void)ctx;
  (void)userdata;
  vprintf(fmt, args);
...
static void default_writef_err(trilog_ctx_t *ctx, const char *fmt, va_list args,
                               void *userdata) {
  (void)ctx;
  (void)userdata;
...
static int default_read_char(trilog_ctx_t *ctx, void *userdata) {
  (void)ctx;
  (void)userdata;
  return getchar();
}

static char *default_read_line(trilog_ctx_t *ctx, char *buf, int size,
                               void *userdata) {
  (void)ctx;
  (void)userdata;
...
static void *default_file_open(trilog_ctx_t *ctx, const char *path,
...
static void default_file_close(trilog_ctx_t *ctx, void *handle,
                               void *userdata) {
  (void)ctx;
  (void)userdata;
  if (handle)
...
static char *default_file_read_line(trilog_ctx_t *ctx, void *handle, char *buf,
...
static bool default_file_write(trilog_ctx_t *ctx, void *handle, const char *str,
                               void *userdata) {
  (void)ctx;
  (void)userdata;
...
static bool default_file_exists(trilog_ctx_t *ctx, const char *path,
                                void *userdata) {
  (void)ctx;
  (void)userdata;
  struct stat st;
...
static long long default_file_mtime(trilog_ctx_t *ctx, const char *path,
                                    void *userdata) {
  (void)ctx;
  (void)userdata;
  struct stat st;
...
void toplevel_query(trilog_ctx_t *ctx, char *query) {
  ...
  bool found = trilog_exec_query_multi(ctx, query, toplevel_emit_all_cb, &st);
